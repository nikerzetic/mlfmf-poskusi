...
unicode_to_latex = {
    ...
    u"\u27E9": "\\rangle",
    u"\u203F": "\\smallsmile",
    u"\u229C": "\\circleeq", #HACK: This isn't a valid LaTeX command
    u"\u02e2": "{^s}",
    u"\u1d47": "{^b}",
    u"\u1d63": "{_r}",
    u"\u02b0": "{^h}",
    ...
    "ⁱ": "{^i}",
    "𝒇": "\\mathscr{f}",
    "𝓣": "\\mathscr{T}", # TODO: this is supposed to be bold
    "𝒈": "\\mathscr{g}",
    "𝕐": "\\mathbb{Y}",
    "𝕊": "\\mathbb{S}",
    "𝑒": "\\mathscr{e}",
