...
if __name__ == "__main__":
    # HACK: overriding argsparser for debugging
    # print(sys.argv)
    sys.argv = [
        "code2vec-master/code2vec.py",
        "--data",
        "data/stdlib/stdlib",
        "--test",
        "data/stdlib/stdlib.val.c2v",
        "--save",
        "models/stdlib/saved_model",
    ]

    config = Config(
        set_defaults=True, load_from_args=True, verify=True
    )  # XXX: unclear where args are parsed
